...
class ImageObject(object):
    ...
    def reconstruct(self):
        ...
        imageio.imwrite(self.image_output_directory / ("black_and_white_" + self.image_name), groundtruth_image)
        imageio.imwrite(self.image_output_directory / ("clone_detection_" + self.image_name), lined_image)

        return self.image_output_directory /  "lined_" / self.image_name
